...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <form action="<?= base_url('admin/pages/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row g-4">
                <div class="col-md-8">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="<?= old('title') ?>" required placeholder="Masukkan judul halaman...">
                        <div class="form-text">Slug URL akan dibuat secara otomatis dari judul ini.</div>
                    </div>
                    ...
                    <div class="bg-light p-4 rounded-3 border">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="category" name="category" required>
                                ...
                                <option value="profil_kanwil" <?= old('category') == 'profil_kanwil' ? 'selected' : '' ?>>Profil Kanwil</option>
                                <option value="profil_ppid" <?= old('category') == 'profil_ppid' ? 'selected' : '' ?>>Profil PPID</option>
                                <option value="standar_layanan" <?= old('category') == 'standar_layanan' ? 'selected' : '' ?>>Standar Layanan</option>
                                <option value="layanan_informasi" <?= old('category') == 'layanan_informasi' ? 'selected' : '' ?>>Layanan Informasi</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text small">Format: PDF, Word, Excel. Maksimal 10MB.</div>
                        </div>
