                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="type" name="type" required>
                                ...
                                <option value="uu" <?= old('type') == 'uu' ? 'selected' : '' ?>>Undang-Undang (UU)</option>
                                <option value="pp" <?= old('type') == 'pp' ? 'selected' : '' ?>>Peraturan Pemerintah (PP)</option>
                                <option value="perki" <?= old('type') == 'perki' ? 'selected' : '' ?>>Peraturan KI (Perki)</option>
                                <option value="pma" <?= old('type') == 'pma' ? 'selected' : '' ?>>Peraturan Menteri (PMA)</option>
                                <option value="sk" <?= old('type') == 'sk' ? 'selected' : '' ?>>Surat Keputusan (SK)</option>
                            </select>
                        </div>
